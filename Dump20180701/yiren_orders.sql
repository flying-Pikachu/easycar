...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `order_carID` FOREIGN KEY (`carID`) REFERENCES `cars` (`carID`),
  CONSTRAINT `order_userName` FOREIGN KEY (`userName`) REFERENCES `users` (`userName`) ON DELETE CASCADE ON UPDATE CASCADE
